          ...
          >
            ...
            <div className="mt-12">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-3 font-body text-xs uppercase tracking-[0.2em] bg-gold text-primary px-8 py-4 hover:bg-gold-light transition-all duration-500"
              >
